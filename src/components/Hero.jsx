          ...
          <div className="flex flex-col justify-center space-y-6 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white  lg:px-6 py-3 rounded-lg font-medium text-lg mx-8 lg:mx-auto transition"
              >
              ...
              <a
                href="#directory"
                className="inline-flex items-center justify-center gap-2 bg-[#1ab9d6] hover:bg-[#086676] hover:text-slate-200 text-slate-900 px-6 py-3 rounded-lg font-medium text-lg mx-8  transition"
              >
